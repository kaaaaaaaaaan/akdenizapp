...
import 'package:sonartiksonnnnnn/foto_kaydetme/kaydolma_foto_alma.dart';
        ...
        return AlertDialog(
          ...
          actions: <Widget>[
            ...
            TextButton(
              onPressed: () {
                Navigator.of(context).pop(); // Dialogu kapat
                // Burada yeni bir sayfaya yönlendirme yapılabilir
                print(currentPosition);
                print(address);
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => KaydolmaFotoAlma()),
                );
              },
              child: Text('Eminim'),
            ),
